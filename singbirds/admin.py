...
from .collectData.collectParameters import extract_acoustic_features
...
class BirdDetailAdmin(admin.ModelAdmin):
    ...
    actions = [generate_spectrograms_action, extract_acoustic_features]
...
admin.site.register(AcousticParameters)
